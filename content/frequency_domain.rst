...
Note that a lot of textbooks and other resources use :math:`\omega` in place of the :math:`2\pi f`, where :math:`w` is angular frequency in radians per second, while :math:`f` is in Hz.  All you have to know is that
